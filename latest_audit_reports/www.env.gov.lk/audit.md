...
Email domain env.gov.lk is not part of the site domain www.env.gov.lk
...
| email_in_site_domain | ❌ | Email domain env.gov.lk is not part of the site domain www.env.gov.lk |
| email_domain_has_mx | ✅ | Found 3 MX record(s) for env.gov.lk |
