...
Email domain mostr.gov.lk is not part of the site domain most.gov.lk

| Test | Result | Details |
| --- | --- | --- |
| postal_address | ❓ | No passing postal address evidence found |
| reachable_contacts | ✅ | Phone: +94) 112 879 412 (57 phone numbers found); Email: info@mostr.gov.lk |
| named_responsibility | ✅ | Published named responsibility: division |
| email_in_site_domain | ❌ | Email domain mostr.gov.lk is not part of the site domain most.gov.lk |
| email_domain_has_mx | ✅ | Found 3 MX record(s) for mostr.gov.lk |
